...
{
	var unit_id     = "2113208";
	var client_ip   = "121.14.24.178";
	var server_time = "1308543269";
	var verify_code = "5c070f73";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2113208/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
